        ...
        <div class="navbar-header border-right">
          ...
          <a class="navbar-brand" href="index.html">
            ...
            <b class="logo-icon">
              ...
              <!-- Dark Logo icon -->
              <img src="/static/assets/images/logos/logo-icon.png" alt="homepage" class="dark-logo" />
              <!-- Light Logo icon -->
              <img src="/static/assets/images/logos/logo-light-icon.png" alt="homepage" class="light-logo" />
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span class="logo-text">
                <!-- dark Logo text -->
                <img src="/static/assets/images/logos/logo-text.png" alt="homepage" class="dark-logo" />
                <!-- Light Logo text -->    
                <img src="/static/assets/images/logos/logo-light-text.png" class="light-logo" alt="homepage" />
            </span>
          </a>
          <!-- ============================================================== -->
          <!-- End Logo -->
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav float-right">
            ...
            <!-- ============================================================== -->
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img src="/static/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="36">
                  <span class="ml-2 font-medium">usuario</span><span class="fas fa-angle-down ml-2"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                  <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                    <div class=""><img src="/static/assets/images/users/1.jpg" alt="user" class="rounded" width="80"></div>
                    <div class="ml-2">
                      <h4 class="mb-0">usuario</h4>
                      <p class=" mb-0 text-muted">correo@correo.com</p>
                      <a href="#" class="btn btn-sm btn-danger text-white mt-2 btn-rounded">Ver Panel</a>
                    </div>
                  </div>
                  <a class="dropdown-item" href="#"><i class="ti-user mr-1 ml-1"></i> Mi Panel</a>
